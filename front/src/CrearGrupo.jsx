...
function CrearGrupo() {
    ...
    useEffect(() => {
        const fetchUsers = async () => {
            try {
                const response = await fetch('https://localhost:8080/myApi/usuarios'); // Cambia la URL si es necesario
                if (!response.ok) {
    ...
    const subirGrupo = async (e) => {
        ...
        try{
            ...
            const response = await fetch('https://localhost:8080/myApi/grupos', {
                method: 'POST',
                headers: {
